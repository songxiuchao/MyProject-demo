...
CREATE TABLE `order` (
  ...
  `msg` varchar(36) DEFAULT NULL COMMENT '日志信息',
...
-- ----------------------------
INSERT INTO `sys_login_log` VALUES ('1192326910760226818', '登录日志', '1', '2019-11-07 14:24:22', '成功', null, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES ('1192331011149565954', '登录日志', '1', '2019-11-07 14:40:40', '成功', null, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES ('1192332027127410689', '登录日志', '1', '2019-11-07 14:44:42', '成功', null, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES ('1192332469886529537', '登录日志', '1', '2019-11-07 14:46:28', '成功', null, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES ('1192336721530871809', '登录日志', '1', '2019-11-07 15:03:22', '成功', null, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES ('1192363998545305601', '登录日志', '1', '2019-11-07 16:51:45', '成功', null, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES ('1192365571874791425', '登录日志', '1', '2019-11-07 16:58:00', '成功', null, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES ('1192603389960179714', '登录日志', '1', '2019-11-08 08:43:00', '成功', null, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES ('1192608590272163841', '登录日志', '1', '2019-11-08 09:03:40', '成功', null, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES ('1192615059067547650', '登录日志', '1', '2019-11-08 09:29:22', '成功', null, '0:0:0:0:0:0:0:1');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '1124606971782160385', 'admin', '17db03c22596b7609c7c9704f16663e0', 'abcdef', 'sxc', '2018-11-16 00:00:00', 'M', 'sn93@qq.com', '18200000000', '1', '25', 'ENABLE', '2016-01-29 08:49:53', null, '2019-06-28 14:38:19', '24', '25');
...
CREATE TABLE `user` (
  ...
  `avatar` varchar(255) DEFAULT NULL COMMENT '头像',
  `account` varchar(18) DEFAULT NULL COMMENT '账号',
  `password` varchar(64) DEFAULT NULL COMMENT '密码',
  `salt` varchar(10) DEFAULT NULL COMMENT 'salt',
  `birthday` varchar(10) DEFAULT NULL COMMENT '生日',
  `sex` int(2) DEFAULT NULL COMMENT '性别(字典)',
  `email` varchar(16) DEFAULT NULL COMMENT '电子邮件',
  `phone` varchar(11) DEFAULT NULL COMMENT '电话号码',
  `role_id` varchar(32) DEFAULT NULL COMMENT '角色id(多个逗号隔开)',
  `dept_id` varchar(32) DEFAULT NULL COMMENT '部门id(多个逗号隔开)',
  `status` varchar(2) DEFAULT NULL COMMENT '状态(字典)',
  `create_user` int(11) DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_user` int(11) DEFAULT NULL COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `version` varchar(255) DEFAULT NULL COMMENT '乐观锁',
  PRIMARY KEY (`id`)
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', '22', '青岛市市南区', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1573038441639&di=8fcaf27b622e8813ea4ce6d4107b0b9a&imgtype=0&src=http%3A%2F%2Fb-ssl.duitang.com%2Fuploads%2Fitem%2F20181%2F20%2F201812018342_JyR3y.jpeg', '123456', '5f1d7a84db00d2fce00b31a7fc73224f', '123456', '1998', '2', '1528856973@qq.co', '15666131983', '1,2', '1,2', '1', '1', '2019-11-06 16:23:14', '1', '2019-11-06 16:23:18', 'ENABLE');
